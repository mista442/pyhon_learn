'''Задание 3: В скрипте сделан генератор конфигурации для access-портов.
Сделать аналогичный генератор конфигурации для портов trunk. В транках ситуация усложняется
...
# access = {"0/12": "10", "0/14": "11", "0/16": "17", "0/17": "150"}
#
# for intf, vlan in access.items(): # intf - ключ, vlan - значение
#     print("interface FastEthernet" + intf)
#
#     for command in access_template:
#         if command.endswith("access vlan"):
