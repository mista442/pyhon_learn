...
#print(london_co[(input("Введите название устройства: "))][(input("Введите имя параметра: "))])
#print(london_co[(input("Введите название устройства: "))],london_co[(input("Введите имя параметра: "))])
