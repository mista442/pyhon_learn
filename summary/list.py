...
# list1=[1,2,3]
# list1.extend([4,5,6]) # так же можно делать расширение списка без предварительного задания списка в отдельной переменной, а прямо задать в методе extend.
# print(list1) # [1, 2, 3, 4, 5, 6]
#
# list1.extend([1,2,3])
# print(list1) # [1, 2, 3, 4, 5, 6, 1, 2, 3]
...
# print(c[4:]) # [['world', 'test', -3.5, 99], 'test', 45, 'change']
...
# print(c[4:][0:3]) # [['world', 'test', -3.5, 99], 'test', 45]
...
# объект c так же копируется для объекта d. Поэтому все изменения на любую из этих переменных будет применяеться на
...
# print(c) # c = [15, 28, 'world', 'tank', ['world', 'test', -3.5, 99], 'test', 45, 'change']
# d=c
# c[4][2]=-1.0
# print(c)  # c = [15, 28, 'world', 'tank', ['world', 'test', -1.0, 99], 'test', 45, 'change']
...
# с = [15, 28, 'world', 'tank', ['world', 'test', -1.0, 99], 'test', 45, 'change']
...
# e=c.copy()
# # или так
# e=c[:] # результат будет аналогичный методу сopy. В данном случае через срез будет выполнено копирование по значению
# c[3]='buklya' # изменяем в переменной c значение 'tank' на 'buklya'.
# # изменения будет сделаны только для переменной с, т.к ранее делали срез значения переменной c в переменную е. И теперь
# # это разные переменные, которые независимы друг от друга.
#
# print("id(c)", id(c))
# print("id(e)", id(e))
...
# НО метод copy копирует по значению только для СПИСКОВ 1-ГО УРОВНЯ. Все вложенные списки будут копироваться по ссылке!!
